...
fun CreateExpenseFunnelScreen(viewModel: PitakaViewModel,onDone:()->Unit){
    var name by remember{mutableStateOf("")};var limit by remember{mutableStateOf("")};var currency by remember{mutableStateOf("PHP")};var from by remember{mutableStateOf<Long?>(null)};var until by remember{mutableStateOf<Long?>(null)};var style by remember{mutableStateOf("solid")}
